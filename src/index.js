...
let content = {
  ...
  "acceuilTexte1": {
    "en": "Because we live in a moving world, enjoying the most of it leads to success. That is why Trust in Move helps companies to move towards tomorrow: internationalisation, export, sales efficiency, change management.",
    ...
    "de": "In unserer ständig bewegenden Welt, Vorteil davon ziehen zu können, führt zum Erfolg. Deshalb hilft Trust in Move Betriebe, sich auf dem Weg Richtung Morgen zu machen: Internationalisierung, Export, Vertriebseffizienz, Veränderungserleichterung.",
  ...
  "a1Texte1": {
    ...
    "de": "Trust in Move macht Frankreich einfach für Sie.<br>Für <strong>strategische interkulturelle Beratungen</strong>, Audit oder <strong>operative Unterstützung auf Ihre Märkte</strong>, Externalisierung von Ihrer Vertriebsteam, oder um Ihnen dabei zu helfen, die perfekten Geschäftspartner in Frankreich (stark sowohl in Technik als auch Vertrieb) zu finden, Trust in Move ist für Sie da.",
    "sp": "Trust in Move vous facilite l'international.<br>Que ce soit pour du <strong>conseil stratégique</strong> ou un audit, de <strong>l'appui opérationnel</strong> sur vos marchés, de l'externalisation de votre équipe commerciale ou pour vous aider à <strong>choisir le bon partenaire à l'étranger</strong> (qui allie compétences techniques et efficacité commerciale), Trust in Move est là pour vous."
  },
  "a1Texte2": {
  ...
  "a2Texte2": {
    "en": "Our <strong>customized</strong> training programs are dedicated for all learners who work in an international context: executive managers, sales persons, as well as project managers, technicians or engineers…",
  ...
  "a3Texte1": {
    "en": "Because internationalisation means often <strong>deep changes</strong> changes in organisations, Trust in Move has developed solutions of change management.",
  ...
  "a3Texte2": {
    "en": "With different techniques of <strong>collective intelligence</strong>, meeting facilitation, co-development, or improvisation theater, Trust in Move help your teams to change so that your strategy for tomorrow gets true already today.",
  ...
  "a3Texte3": {
    "en": "Based in Western France (vibrant city of Nantes, close to Paris, Brittany and Atlantic Ocean), Trust in Move works for any kind of organisation, based in France or worldwide.",
  ...
  "qTitle": {
    "en": "Internationalisation and Change management - Consultant and Trainer",
    "fr": "Consultante Formatrice Export",
    "de": "Internationalisation and Veränderungserleichterung  - Beratung und Schulung",
  ...
  "qTexte4": {
    ...
    "de": "Als <strong>mehrsprachigen Ingenieur</strong> (Deutsch, Englisch, Französisch und Spanisch), war Sylvie sehr schnell in Position geführt, Maschinen weltweit zu verkaufen. Aber internationale Verhandlung oder Exportsverträge brauchen ein spezifisches Know-How. Genau das teilt heute Sylvie mit Trust in Moves Kunden.",
  ...
  "cTexte1": {
    ...
    "de": "IL MANQUE LA TRADUCTION: Sylvie Péan fondatrice de Trust in Move",
  ...
  "lTexte2": {
    ...
    "de": "Trust in Move ist Mitglied der Selbstständigengenossenschaft Ouvre-Boites 44, die die Verwaltung der Aktivität macht, und die folgende Adresse hat: SCOP Ouvre-Boites 44, 8 Avenue des Thébaudières, 44800 St Herblain, Frankreich, tel : +33228216510.",
  ...
  "lTexte7": {
    ...
    "de": "Schulung Registriernummer: 52 44 04429 44 (Région Pays de la Loire).",
  ...
  "lTexte9": {
    ...
    "de": "<strong>Eigentümerin, kreiert durch, inhaltsverantwortung der Webseite:</strong> Sylvie Péan – boulevard des Poilus, 44300 Nantes, France",
